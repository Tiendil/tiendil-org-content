...
2. Исчерапан запа архитектурного развития. Иначе вместо O1 OpenAI выпустили бы GPT-4.5 или GPT-5, заметно превосходящие GPT-4 по качеству.
3. Мы сейчас на этапе построения надсистем над генеративными базами знаний.
4. Возможности генеративных баз знаний понятны, скорее всего они будут оставаться на уровне GPT-4 плюс-минус.

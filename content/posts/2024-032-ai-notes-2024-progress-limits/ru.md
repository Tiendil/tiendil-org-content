...
Вариант 4 — пререготива пользователей моделей, он не меняет форму моделей, но позволяет повышать точность их результатов задорого.
...
Вариант 4 по своей сути не может

, усилия разработчиков сосредоточены на варианте 3 и, возможно, на варианте 3.

Причём O1 можно считать гибридом третьего и четвёртго вариантов. Де-факто это всё-ещё одна специализированная модель, де-юре её используют как ... НЕ ВЕРНО, её не используют для коррекции ошибок!!! НЕ ВЕРНО, O1 всё ещё модель общего назначения.

С вараинтов три много вопросов:

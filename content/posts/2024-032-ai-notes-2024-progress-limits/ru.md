...
4. Старость (?) — GPT-5 — когда все возможности для радикального улучшения технологии исчерпаны, мы берём в руки напильник и начинаем долгий процесс её оптимизации. Улучшаться технология может ещё долго и, суммарно, стать значительно лучше, но эспотенциальный рост закончен. Например, в интернетах упорно ходят слухи, что ждать новых чудес от GPT-5 не стоит.
...
Например, в какой-то момент стало нецелесорбразно вкладывать основные ресурсы в масштабирование данных и утилизацию железа и переключились на оптимизацию архитектуры. Когда архитектуру дотюнили, случился момент, когда вкладывать основные средства в тюнинг архитектуры стало не так выгодно по сравнению с постройкой надситстемы.
...
Соответственно, какие предположения мы можем сделать:

1. Исчерпан запас экстенсивного развития (масштабирование данных и железа). Если бы он не был исчерапан, продолжали бы выпускать GPT-3.X модели, их бы масштабировали для работы на 2,5,10,100500 видюхах одновременно, NVidia выпускалаба сверхоптимизированное железо для запуска сверхутпых, но гигантских нейронок и т.п.
2. Исчерапан запа архитектурного развития. OpenAI (как и все остальные) не смогли за длительное время изобрести или купить технологию, которая позволила бы продолжать модернизировать архитектуру). Иначе вместо O1 OpenAI выпустили бы GPT-4.5 или GPT-5, заметно превосходящие GPT-4 по качеству.
3. Мы сейчас на этапе построения надсистем над генеративными базами знаний.
4. Возможности генеративных баз знаний понятны, скорее всего они будут оставаться на уровне GPT-4 плюс-минус. Само собой, они будут становиться быстрее, меньше и т.п.

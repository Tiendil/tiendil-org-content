...
## Важно разделять свойства `GKB` и её конкретных реализаций

Что я не считаю свойствами `GKB` Но что присутствует в большинстве современных реализаций.

- Сжатие информации в векторную форму (эмбединги) — это типичные детали реализации.

ТУДУ:
ТУДУ: Оциональная мультимодальность — работа с разными типами информации: текст, изображения, звук, видео, etc.
ТУДУ: хранение с потерями свойство, а необходимость обучения — не свойство.

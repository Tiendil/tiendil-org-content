...
В условиях, когда централизованное управление системой становится невозможным, а направлять её куда-то всё-таки надо, остаётся либо полагаться на удачу, лиюо запускать эволюционные/адаптационные процессы через самоорганизацию её частей.
...
TODO: большее уделение внимание взаимодействию продукта (как целого) с внешней средой (через анализ его свойств).

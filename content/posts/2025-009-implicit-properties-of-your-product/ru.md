...
<!-- TODO давайте начнём с этих свойств и по цепочке логики пройдём по разным всё более сложным точкам зрения на продукт и управление им -->

<!-- TODO: do not forget about the last note at the end of the post -->

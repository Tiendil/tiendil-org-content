...
Неявные свойства имеют разную степень влияния на успешность продукта. К тому же, сила влияния зависит от типа продукта, от рынка, от среза пользователей и от множества других факторов.

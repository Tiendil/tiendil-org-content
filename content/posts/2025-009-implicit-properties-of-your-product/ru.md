...
Поэтому, де-факто, неявные свойства продукта являются такой же полноправной его частью, как и та же функциональность. Мы должны оценивать и учитывать их влияние на успешность продукта, мы должны выделять ресусы на их реализацию, иными словами, мы должны управлять ими.

...
Хаотическая природа предполагает практическую невозможность надёжного централизованного долгосрочного планирования жизненного пути продукта, в том числе его свойств. Теоретическая возможность, пока что, есть. Вот, например, квантовые компьютеры обещают нам что-то похожее для более прикладных задач.

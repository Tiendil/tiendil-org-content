...
Даже если используется итерационный вывод (любого рода), каждая итерация всё равно пытается двигать ответ во всех направлениях и, из-за вероятностной природы, всё равно загрязняет ответ неверными и/или ненужными ответвлениями.
...
- Это не тот формат ответа, который люди (ок, профессионалы) привыкли получать — его надо воспринимать и перерабатывать по-другому — более оборазно, менее аналитически — требуется отдельный навык.

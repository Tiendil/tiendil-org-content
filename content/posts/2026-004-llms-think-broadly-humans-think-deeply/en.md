...
But since LLMs are essentially [probabilistic databases]{post:ai-notes-2024-generative-knowledge-base}, and probability a very limited sense of direction, an LLM generates an answer in all possible directions.
...
- This is not the kind of answer people (ok, professionals) are used to work with. It has to be perceived and processed differently: more intuitively, less analytically. That requires a separate skill.

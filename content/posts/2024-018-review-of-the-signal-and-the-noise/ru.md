...
Нейт последовательный [байесианец](https://ru.wikipedia.org/wiki/Байесианство) и даёт хорошее описание байесовского взгляда на вероятность простыми словами. Я редко встречал доступный рассказ про байесовское принятие решений, за это однозначный плюс книге.

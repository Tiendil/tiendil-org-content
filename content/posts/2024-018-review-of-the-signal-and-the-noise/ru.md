...
- Постобработка экспертами способна увеличить точность компьютерных прогнозов осадков на 25%, а прогнозов погоды на 10%. Эта статистика не меняется со временем, то есть не зависит от используемых технологий.
...
- Вероятность события в Х% говорит, что на большом интервале времени / при проверки большого количества аналогичных ситуаций это событие будет случаться в X% случаев. Если это не выполняется, можно утверждать, что прогноз был плох.
...
Качество прогнозов можно оценивать по-разному. Например, для прогнозов погоды метрикой качества могут быть:
...
Все три варианта конфликтуют между собой.

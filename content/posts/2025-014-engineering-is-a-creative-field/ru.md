...
**Почему большинство (мета)теорий о менеджменте (инженерном) выводится из опыта физического производства, а не из опыта научных коллективов.** К слову, в прошлом посте с [обзором топовых книг о менеджменте]{post:vantage-on-management-books} на 8 книг был только 1 пример научного коллектива ([NASA](https://ru.wikipedia.org/wiki/НАСА)) — это меня в некоторой степени шокировало (книг в посте 9, последняя посвящена строго менеджменту в науке, поэтому её не считаю).

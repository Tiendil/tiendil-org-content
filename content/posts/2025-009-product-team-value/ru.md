...
Для нужд этого эссе не важно какие именно модели вы используете (их больше одной, правда?), важно как её использовать.
///

?Как и любую задачу её можно решать с двух сторон:?

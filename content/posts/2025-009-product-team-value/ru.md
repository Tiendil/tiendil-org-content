...
Кратким и правильным ответом будет: it depends.
...
<!-- Обратите внимание, что разница в сложности управления машинами с автоматической и механической коробками передач уже довольно заметна -->

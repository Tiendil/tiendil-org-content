...
Бакалавриат, магистратура, PhD — всё это проходится через создание публичных артефактов (публикаций, диссертации, etc). А после PhD какие «квалификационные ворота» есть, которые требуют публичных артефактов? Вроде ты рассказывала, что в заявке на профессорство что-то такое требуется.

- Карьерные Milestone/gates как требование к публичным артефактам

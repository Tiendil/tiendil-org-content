...
- 80% кода легко можно открыть или использовать open source аналог, допатчив его до нужного состояния.
- сертификаты с курсов — херовые критерии, так как это не свидетельствво непубличной работы.
- выделение рабочего времени — это расходы на качество.
- артефакт, как результат работы (пост как результат работы девопс)
- рейтинг stackoverflow.

<!-- Было бы круто иметь систему постов, организованную как гит репозиторий, когда каждый подписывает свою репу на чужие посты -->

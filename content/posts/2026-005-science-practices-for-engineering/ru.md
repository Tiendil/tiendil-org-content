...
Понятие «практика» само по себе довольно широкое и неточное. Я не буду пытаться его формализировать — для нужд этого поста это скорее будет вредно, чем полезно. Вместо этого мы будем рассматривать культурные [мемплексы]{post:genes-memes-memeplexes}, как собрания взаимосвязанных практик.

<!-- TODO: убрать пассаж про мемплексы, такак теперь разбивка скорее по слоям? -->
...
Сдесь и далее под «институтом» следует понимать не юридическую организацию, а [социальное явление](https://ru.wikipedia.org/wiki/Социальный_институт).
...
Вместо этого я попытаюсь сосредоточиться на максимально узкомом наборе практик, отсутствие которых я считаю наиболее заметным и болезненным в инженерии.

### Проблемы науки

Современная наука поражена множеством болезней (а когда было иначе?). Не всегда и не везде всё работает как должно.

На мой взгляд это не свидетельство неэффективности её практик (особенно тех, которые я использую в этом тексте), а свидтельство продолжающегося её развития, ну, и, природы человечества, конечно.
...
В этом эссе есть места, где стоило бы вставить «примерно также и в open source» или «open source развивается примерно в этом же направлении». Я не буду оставлять подобные сноски, так как их будет слишком много.
...
<!-- TODO: действительно ли будем расшифровывать? -->
...
Сложность с подобным делением в том, что наука — это сложная и древняя система, поэтому всё в ней взаимосвязанно кучей нетривиальных способов. Настолько прямолинейый подход к её структуре неизбежно будет стирать важные нюансы и чрезмерно упрощать картину. Абстракция слоёв должна быть достаточна для нашей задачи — заимствования научных практик для инженерии. Но не следует смотреть на неё как на глубокое описание научной культуры.

Наука не появилась в том виде, в котором она существует сейчас. Она прошла долгий путь от разрозненных методологий отдельных учёных, через частные организации к глобальной институциализированной культуре. Можно сказать, что методология формировала организацию, которая формировала институты, которые поддерживали бы методологию необходимую для достижения «целей» науки. Поэтому в исторической перспективе методологическую культуру можно считать «первичной» (в некоторой степени).

Однако сейчас ситуация немного другая. Наука продолжает эволюционировать, но многие её методологические практики концептуально устаканились, институты играют более сильную регулирующую/поддерживающую/направляющую роль по отношению к метолологии, а организации выступают посредниками между методологией и институтами. По крайней мере так оно выглядит в моей голове.
...
Прикладные научные практики довольно устоялись и нас не интересует их фронтир, поэтому я просто перечислю те практики и концепции, которые, на мой взгляд, отсутствуют или почти отсутствуют в инженерии, но которые вот прям обязательно заимствовать. С небольшими комментариями.

???Гипотеза + эксперимент + толерантность к отрицательным результатам + неопределённость и ошибка.
...
- Цитирование как адресация вклада
- Приоритет и авторство

## Организационная культура

<!-- артефакты -->

- **Артефакт, как результат работы.** - RFC и подобные подходы как аналоги научных статей. Как аналоги научных журналов или баз данных публикаций
- Публичный артефакт, как результат квалификации.
- Портрет профессионала через портфель публичных артефактов (авторство, цитирование)
...
<!-- планирование через гипотезы и эксперименты -->

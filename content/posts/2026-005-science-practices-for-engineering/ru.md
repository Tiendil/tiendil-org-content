...
В науке, публикация в рецензируемом журнале — это не просто способ поделиться результатами, это запись в распределённой базе ~~данных~~ знаний о факте компетенции учёного. Хочешь оценить профессионализм учёного, узнать как интерпретировать его утврждения — посмотри динамику и темы его публикаций.

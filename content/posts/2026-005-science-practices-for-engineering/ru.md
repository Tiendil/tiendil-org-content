...
Учёная степень | Квалификация в IT
---------------|----------------------
...
### Публичные артефкты как KPI сотрудников
...
- Помним, что как только метрика становится целью, она перестаёт быть хорошей метрикой.

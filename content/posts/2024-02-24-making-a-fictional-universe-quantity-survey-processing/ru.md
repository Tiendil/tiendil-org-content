...
В посте вы найдёте «интерактиный исследовательский стенд» с кучей графиков, на которых можно смотреть разницу между двух выборок на ваш выбор. Выборок много — на разный вкус и цвет, поэтому щелкать можно долго — делитесь в [Telegram](https://t.me/tiendil_org_ru) и [Discord](https://discord.gg/ZyNy28ZXM6) найденными закономерностями.

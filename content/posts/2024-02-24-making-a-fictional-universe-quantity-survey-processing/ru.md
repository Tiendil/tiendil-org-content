...
В целом, не воспринимайте этот пост как полноценное исследование. Уверен, многие аналитики мне бы руки за такое оторвали. Пришили и снова оторвали. Пользуйтесь постом как интерфесам к данным, делайте свои выводы.
...
<!-- TODO? -->
К некоторым графикам я буду добавлять очень субъективные комментарии (что посмотреть, какие выводы можно сделать).
...
Выборки меняются глобально: изменение в одном месте приведёт к изменению во всех остальных. То есть вы всегда будете видеть сравнение одних и тех же выборок на всех графиках. Удобно выбирать выборки и проходить по посту сверху вниз.

...
Тут очень зыбкая почтва, так как мало данных и не очень удобен их способ представления.

Для самой целевой группы (`Core` + `Hard` игроки, малое агенство, мало конкуренто) группы посмотрим на срезы по сочетанию факторов из каждой группы свойств.
...
Формально, можно сказать, что вот мы будем ориентироваться на «стратегов, которые любят исследовать мир и хотят это делать в сеттинге конспирологического чёрного юмора». И тогда мы скажем, но наша самая-целевая-целевая аудитория это `21/243` (`Core` + `Hard` стратеги) ~ `8.5%` от любителей стратегий.

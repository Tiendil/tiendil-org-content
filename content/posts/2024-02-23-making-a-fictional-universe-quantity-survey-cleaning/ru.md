...
Также, например, было включено перемешивание вариантов ответа для каждого респондента (Google Forms имеет такую опцию), но после тестирования отключил его. Во многих вопросах варианты идут в какой-то логичной последовательности (например, в порядке убывания реалистичности), перемешивание заставляет людей прыгать между противоположными частями области значений вопроса. Это приводит к путанице и страданиям.
...
7. Некоторые вопросы, которые предполагались как вопросы о стратегических играх, были сформулированы как вопросы об играх в целом. Это путало респондентов. В будущем надо быть внимательнее.
...
От 4chan ждал подставы, игнора или чего-нибудь нейтрального. Был приятно удивлён положительной реакцией. «На хуй», конечно, разок послали, но так, что я даже слезу ностольгии пустил.
...
Лично мне хотелось бы глубже копнуть в крутую опасную журналистику, но реалистичное отображение журналистики — сложная штука.
...
Было достаточно много подобных комментариев. На мой взгляд это круто, значит я что-то нащупал.

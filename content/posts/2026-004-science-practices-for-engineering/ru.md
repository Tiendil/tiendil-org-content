...
<!-- культуры ортогональный практикам? Рассматривать практики по отношению к каждому культурному направлению? -->

Вот они:

<!-- Возможно надо пересмотреть в контексте методологическои и организационной культуры -->
- Культура добычи и обработки информации. <!-- отдельное и чисто прикладное направление -->
<!-- тут идёт понятие публичного артефакта публично верифицированного (журналами, ревью, etc) -->
- Культура обеспечения прозрачности работы.
- Культура сопровождения профессионального роста.
- Культура обмена знаниями.

<!-- Возможно, мы хотим объединить три последние культуры. После этого от концепции культуры в посте можно избавиться совсем? -->
...
## Методологическая и институциональная культуры

С высоты птичьего полёта, можно выделить две группы практик:

- Методологическая культура — как делается работа.
- Организационная культура — как организуется работа.
- Институциональные культура — как организуются институты, которые поддерживают работу.

Этот пост будет в основном про ора

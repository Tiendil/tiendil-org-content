...
- Институциональная культура — как поддерживается работа — практики, которым следует индустрия в целом.
...
Однако сейчас ситуация немного другая. Наука продолжает эволюционировать, но многие её методологические практики концептуально устаканились, институты играют скорее регулирующую/поддерживающую роль, а организации выступают посредниками между методологией и институтами.

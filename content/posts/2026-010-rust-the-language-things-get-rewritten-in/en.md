...
[Composition wins over inheritance]{post:@choose-nearest-language:composition-vs-classification} in most general cases due to better flexibility, more variability, less coupling, and, consequently, better maintainability of the result.

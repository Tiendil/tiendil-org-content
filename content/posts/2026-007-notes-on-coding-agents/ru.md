...
Всё-таки порекомендую посмотреть в сторону базового агента [pi.dev](https://pi.dev/) — он спроектирован с фокусом на расширяемости сторонними инструментами, что в духе следуюго раздела этого поста. Но руками я его пока не успел потрогать.

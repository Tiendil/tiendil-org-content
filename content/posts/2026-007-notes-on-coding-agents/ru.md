...
То есть агент превращается исполняемую спецификацию — машину состояний — и это сейчас стандартный способ описания специализированных агентов. Об этом же и мой пет-проект [Donna](https://github.com/Tiendil/donna).

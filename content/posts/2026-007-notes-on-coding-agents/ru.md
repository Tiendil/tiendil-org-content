...
Поскольку проектирование и анализ у программистов начинают занимать большую часть рабочего времени уже где-то с уровня сеньора, можно утверждать, что радикальные улучшения затрагивают меньшую рабочего времени.
...
- Мы не можем ускорить финальную [проверку гипотез]{post:hypothesis-testing-loop}, но, гипотетически, можем симулировать поведенние пользователей как ещё один этап планирования. Это не ускорит разработку конретной фичи, но может уменьшить долю ошибок и увеличить качество. И, тем самым, уменьшить среднее время доставки фичи до пользователей.
- Мы не можем полностью доверить планирование агентам, но может отдать им существенную часть сбора данных и их предварительного анализа.

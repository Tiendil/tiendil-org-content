...
Более того, текущий «стандартный» контекст в 1 миллион токенов недостаточен, чтобы вместить в себя все знания о проекте (не говоря уже о всех знаниях разработчика), а методы формирования контекста не позволяют надёжно собирать и компоновать выборку необходимой информации.

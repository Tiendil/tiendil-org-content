...
В теории, это может улучшить среднюю температуру по больницы в области качества архитектуры и актуальности кода, что позитивно скажется на жизни разработчиков.

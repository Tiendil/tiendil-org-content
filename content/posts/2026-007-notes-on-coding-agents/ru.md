...
Агент — это классическое не-ИИ ПО — программная обвеска-оркестратор над внутренними и внешними инструментами, которая организует их совместную работу для достижения какой-то цели. Инструменты могут быть разными: внутренний код, консольные утилиты, сайты, [MCP](https://modelcontextprotocol.io/docs/getting-started/intro) сервисы, LLM, etc.

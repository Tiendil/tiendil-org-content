...
Многие, особенно не программисты, путают эти вещи. Частично в этом есть и наша вина, так как опытный программист часто, например, проектирует и кодит напроектированое одновременно — так значительно быстрее. Часто в это же время мы ещё GUI проектируем, тестируем, анализируем и дополняем бизнес требования, etc.

...
**Во-первых**, в качестве подведения итогов по подтягиванию менеджерской теории я планировал написать всего два поста. В итоге [написал пять]{post:points-of-view-on-a-product} и запланировано ещё два :-D И это ещё при том, что я специально объединил [обзоры всех книг]{post:vantage-on-management-books} в одни пост.

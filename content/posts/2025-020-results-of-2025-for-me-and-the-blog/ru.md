...
Оптимизма добавляет то, что люди читалкой интересуются. На текущий момент у [репозитория](https://github.com/Tiendil/feeds.fun) 319 звёздочек — с прошлого месяца это мой самый звёздный проект.
...
Сверху на это наложилось несколько итераций геймдизайна, а в последний месяц я начал экспериментировать с LLM агентами.

...
В процессе — будет тестовый запуск монетизации, после чего решу, на сколько имеет смысл вкладываться в развитие проекта.
...
Успех года. Сейчас у меня 645 карточек с выучеными словами. Поскольку 1000 я брал для красивого числа (100 — мало), считаю это большим прогрессом для себя. Результат виден в реальной жизни — новые слова мелькают то в сериалах, то в книгах, то постах.
...
За вторые полгода 2024 на колу было потрачено около 1000 eur, за весь 2025 год — около 250 eur.

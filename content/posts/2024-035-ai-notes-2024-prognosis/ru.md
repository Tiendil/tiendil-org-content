...
В реальности, насколько я помню, ещё ни одна революция автоматизации не уменьшала абсолютное количество рабочих мест — только перераспределяла их. Бизнес, в принципе, не заинтересован в сокращении производства, только в увеличении. Если что-то получается автоматизировать/оптимизировать/удешевить, то это повод больше масштабироваться, а масштабирование требует тех же работников, но переученых.

...
Встречал мнение, что нейронки помогут любому желающему проверять информацию, расчитывать на это я бы не стал:

- Во-первых, у человека должна быть привычка проверять информацию. У большинства её нет, вырабатывается она с трудом.
- Во-вторых, у человека должно появиться само жалание проверять информацию. А зачем проверять, если она выглядит убедительно?

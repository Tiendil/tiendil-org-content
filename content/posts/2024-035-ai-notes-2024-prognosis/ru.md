...
### В ближашие 10 лет работе профессионалов ничто не угрожает

- Автоматизации труда профессионалов не будет: Периодически встречаю статьи про автоматизацию исследований с помощью LLM, но пока не слышал об их практическом применении. Почему его нет и, скорее всего не будет, расскажу в следующем посте.

...
Глубокое обучение и LLM — это отличный пример синергии и эмерджентности взаимодействия науки и инженерии. Основывась на достижениях физики (наука сдвинула фронтир) инженеры NVidia создали новые вычислительные архитектуры (инженерия сдвинула фронтир), что позволило учёным сделать несколько концептуальных прорывов в нейронных сетях (наука сдвинула фронтир), после чего инженеры OpenAI их отмасштабировали (инженерия сдвинула фронтир) и [мы получили что получили]{post:ai-notes-2024-the-current-state}.

И сейчас, я бы сказал, что в области искусственного интеллекта граница между наукой и инженерией стёрта.

...
Наука концентрируется на объяснительной составляющей модели (почему что-то работает так, а не иначе), инженерия — на предсказательной (как должна быть устроена штука, чтобы она вела себя должным образом в конкретой среде).

...
Во-вторых, де факто, многие научные дисциплины сейчас производят огромное количество прикладного знания, научная новизна которого стоит под вопросом, если следовать букве ~~закона~~ науки. В то же время, многие инженерные отрасли давно оперируют на фронтире человеческих знаний.

Для примера, давайте посмотрим на глубокое обучение и большие языковые модели (LLM).
...
/// note | Если хотите поломать голову философией, ответьте на вопрос
Критерий появился как формализацию сути научной практики или научная практика сформировалась в результате следования критерию новизны?
///

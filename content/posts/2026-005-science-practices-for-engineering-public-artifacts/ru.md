...
Я выбрал KPI для заголовка не потому, что публичные артефакты должны заменить традицонные KPI, а потому что это самый чёткий способ передать идею. На практике оценивать работу людей следует по комплексному набору параметров, не скатываясь в абсолют.

**Более корректно будет смотреть на публичные артефакты как на ещё одну равноправную ось, по которой можно оценивать
сотрудников.**

Добавляю эту ось мы перестраиваем пространство оценки, делая его более выразительным и, следовательно, объективным.

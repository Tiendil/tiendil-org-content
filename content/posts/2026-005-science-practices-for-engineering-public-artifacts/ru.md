...
<!-- TODO: вы снижаете роль специализированных процессов -->
**Во-первых**, вы перекладываете оценку
...
<!-- TODO: что если чувак будет заниматья только публичными артефактами, вместо нанесения прямой пользы -->

...
Согласно моему опыту, большая часть кода продукта и знаний о нём даже близко не является каким-то секретным преимуществом, ноухау и чем-либо ещё — это просто штуки, которые миллионы людей повторяют из продукта в продукт из компании в компанию. Остальная часть кода и знаний не является преимуществом с большой долей вероятности. Особенно это справедливо, если считать только «невидимые» пользователям артефакты.

...
### Для инженера не может быть чётких инструкций

Могут быть рекомендации и ограничения.

  - Для инженеров (и любой другой творческой работы) нет инструкций, есть рекомендации. В момент когда рекомендации превращаются в инструкции, эффективность инжера падает радикально. ТРИЗ как набор рекомендаций. Циклы обратной связи, по сути, это рекурсивная/фрактальная интрукция, что де-факто делает её просто рекомендаций, так как следовать детально ей невозможно.

...
**Поэтому фокус управление инженерными коллективами смещается с персонального уровня на уровень команды и продукта.** Мы оптимизируем не людей, а рабочие процессы (в рамках которых люди действуют), потоков информации (между людьми и процессами) и метрики продукта (частью которого является наша команда).

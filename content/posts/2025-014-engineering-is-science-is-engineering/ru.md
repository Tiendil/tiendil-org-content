...
### Публичные артефакты как источник истины

На мой взгляд, публичные артефакты (в широком смысле) — это одно из самых крутых достижений науки — пракитка, которая во многом сделала нашу цивилизацию такой, какая она есть.

Да, не вся наука строится на публичности. Корпорации, армия, может быть спецслужбы держат часть разработок в секрете. Но:

- Это всё-равно меньшая часть активности.
...
- Публичные артефакты лучше как база для метрик, KPI, оценки компетенций и прочих анализов.
- Публичность артефакта автоматически даёт защиту от трешанины, так как люди больше стараются, когда результат будет виден всем.
- Публичные артефакты увеличивают прозрачность работы людей и команд, задают минимальную планку прозрачности.
- Публичные артефакты запускают обмен знаниями.
- Публичные артефакты создают уникальный профиль специалиста, который участвовал в их создании.

Под публичным артефактом я имею в виду любой публичный результат труда: производимый софт, документация, статьи в блоге, репозиторий, участие в конференциях, выступления, open source проекты и т.д.


### Метрики привязанные к публичным артефактам с демонстрацией новизны

...
- Инженерия — прикладная эпистемология. Архитектура — способ структурировать пространство гипотез и скорость их проверки.
...
- ??? Правильная единица управленческого учёта в инженерии — эксперимент, а не задача
...
- Стырить ли внешнюю практику из науки в инженерию?

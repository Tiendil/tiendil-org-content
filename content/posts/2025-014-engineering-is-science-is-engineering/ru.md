...
Ведь причинно-следственные связи никто не отменял: какой бы крутой ни была ваша команда, какую бы замечательную идею вы ни имели, если это всё пропускается через непредназначенный для этого механизм (процессы), то на выходе вы получите плохой продукт и страдающих людей.

Рабочая культура и процессы — это базис, на котором строится всё остальное. Этот базис может как умножить усилия команды, так и свести их на нет.
...
Тот же софт имет разные виды жизненных циклов, разные ситуации бывают. Например, этап длительной поддержки или вывода из эксплуатации может быть значительно ближе к физическому производству, чем к инженерии, так как там может быть экономически выгоднее делать повторяющуюся работу вместо её автоматизации.

Поэтому всегда надо знать меру, в том числе при выборе практик управления.

Для нужд этого эссе давайте примем, что есть довольного много коллективов, которые занимаются преимущественно творческой работой. В процессе чтения я попытаюсь продемонстрировать, что таких коллективов большинство, по крайней мере в сфере разработки ПО.

<!-- TODO: нужен ли этот пассаж в контекте формы поста? -->
Также хочу обратить ваше внимание на то, что как бы мне не хотелось, написать текс разумного объёма про все возможные инженерные и около инженерные коллективы не получится.

Поэтому я пишу этот пост (как и все в этом блоге) с колокольни моего опыта — это програмная инженерия: сложный бэкенд, игровая логика, средний фронтенд. Плюс геймдизайн, плюс комьюнити менеджмент, плюс инженерный менеджмент. А ещё моя жена — учёный и я последние два года постепенно выпытывал у ней секретные научные практики :-)

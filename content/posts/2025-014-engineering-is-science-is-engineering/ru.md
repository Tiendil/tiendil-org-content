...
Мы это обсуждали в прошлом разделе — инженер всегда создаёт что-то новое.-

Как мы обсуждали ранее, суть работы инженера — создание нового.

инженерная новизна

### Инженеры производят модели окружающей реальности

Обычно это значит, что инженер описывает некоторый артефакт на формальном языке, который будет демонстрировать определённые свойства в заданной среде.
...
Наука сильнее ориентирована на универсальность модели (взять те же попытки найти [теорию всего](https://ru.wikipedia.org/wiki/Теория_всего) в физике), инженерия — на частные случаи (создание модели, которая будет справедлива в очень конкретных условиях).
...
///
  ...
  - **Инженерия как производство знаний** об окружающей реальности. Буквально «как сделать штуку, которая будет в заданном окружении действовать предсказуемым образом».

...
Его механизмы всё ещё ортогональны друг другу, но только в плане ответственности за что-то, а не в возможности комбинировать их любыми способами. Вместо этого они требует от вас использовать их в связке с другими механизмами языка в конкретно определённых случаях. Вместо кирпичиков лего вы получаете намертво сваренную железную решётку, в которую необходимо вписать архитектуру и код.
...
**Rust навязывает ~~хорошую~~ надёжную архитектуру.** И делает это эффективно.

Для продуктивной работы, программист на Rust должен одновременно деражть в голове все механизмы языка: стандартные traits, правила lifetime, правила borrow checker, etc. Причём держать в голове их надо не по отдельности, а с учётом всех их взаимодействий и ограничений на композицию.

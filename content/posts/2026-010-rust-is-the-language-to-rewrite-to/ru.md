...
Мы «знаем» на каких принципах должны работать sudo, core utils, web-серверы, базы данных, пользовательские интерфейсы, etc.
...
- Сверху — корпорации переводят свою инфраструктуру на Rust, так как ценность экспериментирования с кодом снижается, а издержки от багов и уязвимостей растут. Зачем экспериментировать, если всё уже застандаризировано и понятно, примерно, как оно должно работать согласно лучшим практикам?
...
В теории, под это попадает 99% коммерческого софта и существенная часть софта с открытым исходным кодом.

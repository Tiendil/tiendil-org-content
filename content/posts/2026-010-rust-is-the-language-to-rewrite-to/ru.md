...
- Сверху — корпорации начинают переводить инфраструктуру на Rust, так как ценность экспериментирования с кодом снижается, а издержки от багов и уязвимостей растут. Зачем экспериментировать, если всё уже застандаризировано и понятно, примерно, как оно должно работать согласно лучшим практикам?

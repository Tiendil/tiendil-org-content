...
Поскольку в стандартном режиме я могу поддерживать только два трека (и жену!) и люблю кушать, то треки — это работа плюс личные проекты. Самообразование страдает, так как серьёзно учить что-то после работы сил нет. Опять таки, это моя особенность, я легко могу генерировать мозгом идеи или код по 12 часов в день, но модифицировать свою мозг чем-то сложным могу только часа четыре на свежую голову. Документацию читаю за милую душу, а на что-нибудь вроде чтения [Маштаба]{post:scale} — нужно выделять время специально.

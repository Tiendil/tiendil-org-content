...
3. Обилие денег и нехватка рук разработчиков ведёт к максимальному использованию горизонтального масштабировния (наращивания ресурсов). К вертикальному масштабированию (усложнию архитектуры) приходят только когда из горизонтального уже ничего выжать нельзя.

/// details | Подробнее про горизонтальное и вертикальное масштабирование.
Утрируя:

- `горизонтальное масштабирование` — у нас есть что-то, что работает в одном экземпляре. Мы делаем так, чтобы оно работало в 10, 100, 100500 экземплярах и это обеспечивает нам кратный рост возможностей. Для целей данной статьи, мы будем использовать термин `горизонтальное масштабирование` в широком смысле. Мы будем понимать как и докупку серверов, так и увеличение
-
///

Благодаря этому мы можем видеть:

- Как перспективность того или иного пути развития видят сильные мира сего, игнориуя маркетинговый туман, который они же нагнетают.
- Как потенциал конкретной архитектуры/технологии достигает (пред)пика, когда стоимость её мастабирование становится равной стоимости перехода на новую архитектуру.

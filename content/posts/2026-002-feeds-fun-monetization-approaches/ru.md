...
3. Комиссии платёжных провайдеров. Мы будем ориентироваться на самую большую комиссию Stripe: `2.5% + 0.30$ per transaction`, без учёта меньших комиссий в некоторых локациях. Stripe умеет агрегировать все платежи в одни инвойс за период, поэтому нам не нужно моделировать несколько транзакций на одного пользователя.
...
Например, при шаге скидки 20% и марже x2, токены на продвинутой подписке будет продаваться дешевле их COGS.

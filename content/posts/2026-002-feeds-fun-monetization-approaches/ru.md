...
Иными словами: мы будем искать логику монетизации и цены при которых сервис приносил бы 20000$ gross margin при 1000 подписчиках.
...
Суть идеи стабильности в том, что если подобная стабильность возможна по грубым пессимистическим расчётам, то в реальности будет большой простор для оптмимизации.

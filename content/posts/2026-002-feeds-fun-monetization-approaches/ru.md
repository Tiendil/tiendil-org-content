...
Есть стойкое ощущение, что я перестарался с пессимизмом в модели, но не вижу как его открытить без потери уверенности в ней :-D
...
2. Маржа x2-x3 выглядит очень рисковано для проекта типа Feeds Fun.

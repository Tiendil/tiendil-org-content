...
3. Комиссий платёжных провайдеров. Мы будем ориентироваться на Stripe: `2.5% + 0.30$ per transaction`.

Итого: `2575$ / month` + комиссии платёжных провайдеров.
...
То есть, если пользователь находится на подписке которая полностью покрывает его потребление, то он использует всю квоту подписки.

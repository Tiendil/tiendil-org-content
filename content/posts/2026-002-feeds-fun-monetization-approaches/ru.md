...
Кроме размера трат, проблема также и в том, что ты оптимизация конверсий не всегда коррелирует с развитием функциональности проекта. Утрируя, сбор метрик и дашборды пользовательский опыт напрямую не улучшают. То есть есть риск потрать год на проект и не принести пользы реальным пользователям

Пойти, что ли, инвестров поискать.

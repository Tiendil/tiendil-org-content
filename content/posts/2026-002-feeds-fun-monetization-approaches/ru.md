...
Я старался добавить максимум пояснений и контекста, но не уверен что добавил всё и что это весь этот контекст не сделал хуже.

В итоге текст бьёт все рекорды этого блога по блокам комментариев и отступлений :-D
...
По новостям за последние 30 дней, которые обрабатывались Feeds Fun, 95 персентиль по размеру тела новости — это примерно 2500 символов. Однако текущее множество всех новостей довольно специфично: содержит большое количество абстрактов научных статей и коротких постов из Reddit.

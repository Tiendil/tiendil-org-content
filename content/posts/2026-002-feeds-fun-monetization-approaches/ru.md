...
3. Комиссии платёжных провайдеров. Мы будем ориентироваться на самую большую комиссию Stripe: `2.5% + 0.30$ per transaction`, без учёта меньших комиссий в некоторых локациях.

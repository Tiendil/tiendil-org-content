...
- **Подписки + докупка токенов** — пользователь покупает подписку на ожидаемое количество новостей, а сверх этой квоты докупает токены быть несколько тиров подписки с разными квотами.
...
В купе с бесплатным тиром, это три варианта использования сервиса, что должно быть привычно и понятно для пользователей. В то же время, два варианта подписки позволят нам быть гибкими в ценообразовании.

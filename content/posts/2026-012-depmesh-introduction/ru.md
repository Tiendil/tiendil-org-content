...
В контексте последнего пункта, я сейчас экспериментирую с системой, которая автоматически контролирует синхронизированность всех файлов проекта друг с другом, используя [DepMesh](https://github.com/Tiendil/depmesh) для поиска зависимостей и [Donna](https://github.com/Tiendil/donna) для исправления рассинхронизации.

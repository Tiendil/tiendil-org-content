...
`[10] Total Game Owners` — Сколько покупок было совершено за всё время, включая этот месяц.
...
`[14] Standard Edition Revenue` — Сколько заплатили игроки за базовую версию в месяц.

`[15] Delux Edition Revenue` — Сколько заплатили игроки за люксовую версию в месяц.

`[16] Game Revenue`— Сколько заплатили за обе версии в месяц.

`[17] Total Game Revenue` — Сколько заплатили за обе версии за всё время, включая этот месяц.

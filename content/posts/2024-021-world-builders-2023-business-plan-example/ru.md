...
Бинзнес ~~всегда~~ обычно грешит тем, что игнорит задачи с не-самых-обязательных-и-заметных треков, которые не-приносят-value-напрямую. Например, не одобряет задачи по улучшению контролируемости проекта, потому что «сейчас и так всё ок».

...
- `Forgotten Work` — наша оценка доли работы, которую мы забыли для этапа. Коэфициент возрастает, так как первые этапы мы видим лучше, чем последние. Работа на последних будет сильно отличаться от плана из-за накопления ошибки в нашей модели игры и улучшения нашего понимания её же по мере разработки.
...
Многие коэфициенты в Зелёной таблице зависят от компетенции команды и вас в том числе.

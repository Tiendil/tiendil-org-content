...
Самая большая область расходов. В случае моей модели к релизу на маркетинг уйдёт раза в 2.5 больше, чем на разработку :-D

`[54] Marketing Wishlists Cost` — Оценка минимальной перманентной ежемесячной активности по «лёгкому» пиару игры.

`[55] Marketing Videos Cost` — Ожидаемая стоимость разработки видео под конкретные события (релизы).

`[56] Marketing New User Cost`— Ожидаемая стоимость привлечения новых пользователей.

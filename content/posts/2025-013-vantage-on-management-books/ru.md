...
По сути, Kanban — это первый достаточно проработанный, консистентный и доступный набор практик для реально гибкой разработки. Scrum не считается, так как он гибкий только на словах. Исторический [Agile манифест](https://agilemanifesto.org/principles.html) не считается, так как он именно манифест — не все могут им пользоваться.
...
**Автор провёл исследование и построил последовательную теорию на его основе.** Нельзя утверждать, что эта теория детальна или полностью верна, но уже сам факт подобной работы заметно выделяет книгу из ряда прочих.
...
- Учёные посчитали, что [корреляция](https://ru.wikipedia.org/wiki/Корреляция) между реальной производительностью и самооценкой в среднем 0.29, а у менеджеров — 0.04 (!).

Книга завершается утверждением, что бюрократию можно перестроить изнутри. В то же время, Reinventing Organizations утверждает, что сходные преобразования нельзя сделать без поддержки с самого верха. Я пока склоняюсь к мнению из Reinventing Organization.
...
- Многие примеры коммуникаций и решения проблем в коммуникациях выглядят очень [западно-центристскими](https://en.wikipedia.org/wiki/Psychology#WEIRD_bias) — не всем культурам это подойдёт.
...
По-моему, в [Войне и мире](https://ru.wikipedia.org/wiki/Война_и_мир) схожий подход [Толстой](https://ru.wikipedia.org/wiki/Толстой,_Лев_Николаевич) приписывал [Кутузову](https://ru.wikipedia.org/wiki/Кутузов,_Михаил_Илларионович). Причём персонажи книги часто воспринимали эту стратегию как пассивность старика, что их по-своему характеризует.
...
- Реформы в Task Force, отчасти, привели к одной из крупнейших утечек секретных армейских данных в [WikiLeaks](https://wikileaks.org/). Автор книги стоит на позиции, что это неизбежный риск и даже с его учётом реформы стоили того. Не уверен, что с позиции ответственного за это генерала имеет смысл утверждать что-либо другое, но всё же.

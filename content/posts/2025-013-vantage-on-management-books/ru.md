...
## Что из перечилсенного почитать технарю?з

Если вы хотите быстренько прокачаться в менеджменте, то я бы рекомендовал прочитать:

- Kanban — чтобы иметь набор практик для оперативного упрвления, которые можно настраивать в инженерном стиле.
...
- Всё таки или иначе движется к плоским структурам, когда каждый член команды немного шарит в менеджменте => важно для вашей эффективности и для карьеры.
- Пушить плоские структуры, децентрализацию, самоуправление больше всего выгоднее для работинков на исполнительных позициях.
...
Например, для использования психотерапевтами с PhD на семеных парах в 1970-ых. Это вообще никак не относится к профессиональному коллективу из 2020-ых :-)
...
- Средний управленец недостаточно компетентен для использования иснтрументов, требующих специализированного неуправленческого образования. И у него нет времени набрать эту компетенцию.
...
Как только найду что-нибудь стоящее именно про профессиональную культуру, приближенное к реальноссти, обязательно изучу и поделюсь.

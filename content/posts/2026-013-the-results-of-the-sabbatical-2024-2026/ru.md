...
В 2023 году [Юля](https://www.linkedin.com/in/burankova/) сделала таблицу из 1000 лаб, выбрала из них одну, переехала в Геманию и начала делать PhD в ней (учитесь как надо!). Мы год полетали друг к другу между Польшей и Германией, поняли что это жуть как неудобно и дорого, поэтому в я уволился из [Palta](https://palta.com/) и в начале 2024 года перехал прицепом жены в Германию.
...
- Объяснение [что такое творческий отпуск и почему я в них хожу]{post:sabbaticals}.
...
- `[in progress]` разобраться с coding agents и как их использовать для работы.
...
- Моя боязнь немецкой бюрократии и нежелание тратить лишние деньги. В итоге в Feeds Fun для подключения платежей готово всё, кроме юридического лица и обработчика веб-хуков от сервиса платежей. Поэтому этой цели поставлен прогресс в 90%. Планирую добить этот вопрос, когда определюсь, что буду делать после саббатикала.

Теперь можно рассказать более подробно чем я занимался. Для удобства, я разбил все активности на 12 <!-- TODO: перепроверить --> треков:

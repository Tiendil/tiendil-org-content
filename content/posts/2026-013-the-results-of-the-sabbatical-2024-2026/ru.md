...
В процессе добавилось ещё несколько целей:

- `[done]` закончить курс [World Builders 2023]{tags:world-builders-2023} про разработку интеллектуальной собственности и создание вымышленных миров.
- `[done]` разобраться с ИИ хайпом: что есть что и куда оно всё движется.
- `[in progress]` разобраться с codeing agents и как их использовать для работы.

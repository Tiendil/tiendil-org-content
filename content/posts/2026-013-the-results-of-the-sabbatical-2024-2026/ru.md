...
- Представление бэкенда как реляционной базы данных с возможностью делать SQL запросы к ней.
...
Вот такая жуть. Сейчас это выглядит как крайне грязный и неоптимизированный движок с единственной игрой на нём (зато честно навайбкоженой с нуля, включая звук и спрайты).

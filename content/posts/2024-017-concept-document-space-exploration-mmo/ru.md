...
- Все возможности в игре определяются наличием картриджей.
- На картридже могут быть запиааны: части ника игрока, координаты звёздных систем, информация об объектах, рецепты крафта, протоколы коммуникации с планетами и игроками, боевые алгоритмы для корабля, контакты игроков в реальном мире, etc.

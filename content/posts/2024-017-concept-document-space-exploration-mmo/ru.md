---
title = "Концепт-документ ММО про исследование космоса"
...
seo_description = "Концепт-документ ММО про исследование космоса: управляй звёздным кораблём, исследуй бесконечную вселенную, прокладывай звёздные пути, торгуй информацией."
seo_image = "cover.jpg"
---

/// brigid-images
src = "cover.jpg"
caption = "Предполагаемый постер для игры. (c) DALL-E"
///

Ещё один из вариантов концепта [Сказки](https://the-tale.org/) 2.0.

Возможно, последний в этом формате: мне понравилось оформлять [концепт в форме презентации]{post:@choose-nearest-language:world-builders-2023-final-presentation}, пока занимался в школе [World Builders]{tags:world-builders}.

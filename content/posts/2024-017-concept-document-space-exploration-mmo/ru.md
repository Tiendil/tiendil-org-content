...
seo_description = "Концепт-документ ММО про исследование космоса: управляем звёздным кораблём — летающим городом: исследуем бесконечную вселенную, прокладываем маршруты между мирами, объединяйте их в федерации."
...
- Все возможности в игре определяются наличием катриджей у игрока.
...
6. ТУДУ: топология вселенной, которая поддерживает бесконечные исследования.

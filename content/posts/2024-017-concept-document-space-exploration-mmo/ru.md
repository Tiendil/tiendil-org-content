...
1. Подготовить корабль к путешествию в варпе.
...
4. После прибытия починить корабль, изучить новую звёздную систему.

Пример строительства завода на планете:

1. Выбрать какой завод строить.
...
Чтобы повысить монетизацию игроков с большим достатком предполагается градация подписок с ограничением: **все бонусы, которые даёт подписка, распространяются на всех игроков**.
...
- 50$/месяц — Подписка +2 — тоже, что в +1, плюс каждый подписчик увеличивает размер вселенной на 100 систем.
...
5. Необходимые вычислительные ресурсы будут слишком большими, чтобы окупаться нишевой игрой. Необходимо фокусироваться на асинхронных механиках и контролировать метрики, чтобы вовремя определять проблемы.

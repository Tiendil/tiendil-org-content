...
**Не путать с фермами ботов**. Под VC я подразумеваю уникальных персонажей, которые интересны аудитории из-за своих свойств, уникальных реакций на события, истории, стиля, etc. То есть я говорю про что-то вроде ИИ-сериала в социальных сетях.
